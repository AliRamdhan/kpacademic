<section class="w-64 flex h-screen flex-col justify-between border-e bg-white">
    <div class="px-4 py-6">
        ...
        <ul class="mt-6 space-y-1">
            <li>
                <a href="{{ route('lecture.dashboard') }}"
            ...
            <li>
                <details class="group [&_summary::-webkit-details-marker]:hidden">
                    ...
                    <ul class="mt-2 space-y-1 px-4">
                        <li>
                            <a href="{{ route('lecture.supervise.student.recognition') }}"
                                class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                Recognition Student All
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('lecture.supervise.student.recognition.approval') }}"
                                class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                Recognition Student Approval
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('lecture.supervise.student.recognition.report.all') }}"
                                class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                Recognition Report
                                {{-- bukti pelaksanaan  --}}
                            </a>
            ...
            <li>
                <details class="group [&_summary::-webkit-details-marker]:hidden">
                    ...
                    <ul class="mt-2 space-y-1 px-4">
                        <li>
                            <a href="{{ route('lecture.supervise.student.location') }}"
                                class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                KP Student All
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('lecture.supervise.student.location.approval') }}"
                                class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                KP Student Approval
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('lecture.supervise.student.location.report.all') }}"
                                class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                                KP Student Report
                                {{-- bukti pelaksanaan  --}}
                            </a>
