        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                <thead class="ltr:text-left rtl:text-right">
                    <tr>
                        <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">Report Title</th>
                        <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">Report Date</th>
                        <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">Recognition Courses
                        </th>
                        <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">Recognition Reason
                        </th>
                ...
                <tbody class="divide-y divide-gray-200">
                        ...
                        @foreach ($reportsRecognition as $report)
                            <tr class="text-center h-16">
                                ...
                                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">
                                    ...
                                    {{ $report->recognition->Courses->coursesSKS }}
                                    SKS
                                </td>
                                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">
                                    {{ $report->recognition->recognitionReason }}
                                </td>
                                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">
                                    {{ $report->recognition->MBKMCourses->mbkmCoursesName }} -
                                    {{ $report->recognition->MBKMCourses->mbkmCoursesDuration }}
                                </td>
                                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">
                                    {{ $report->reportDate }}
                                </td>
                    ...
                    @else
                        <tr class="w-full h-20 text-center">
                            <td colspan="6" class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Yout are
                                not create report recognition yet</td>
                        </tr>
                    @endif
                </tbody>
            </table>
                    ...
                    @if ($reportsKP->isNotEmpty())
                        @foreach ($reportsKP as $report)
                            <tr class="text-center h-16">
                                ...
                                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">
                                    {{ $report->locationKP->locationName }}
                                </td>
                                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">
                                    {{ $report->locationKP->locationReason }}
                                </td>
                                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-base">
                                    {{ $report->locationKP->created_at }}
                                </td>
                            </tr>
                        @endforeach
                    @else
