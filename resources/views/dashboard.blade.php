        ...
        <div class="max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
                <div class="mx-auto lg:pl-12 max-w-lg lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
                    ...
                    <ul class="w-full text-md text-gray-600 px-8">
                    ...
                    <a href="{{route('dashboard')}}"
                        class="mt-4 inline-block rounded bg-indigo-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-indigo-700 focus:outline-none focus:ring focus:ring-yellow-400  lg:ml-8">
                        Get Started Today
                    </a>
                </div>
